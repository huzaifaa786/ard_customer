    ...
    try {
      ...
      try {
        ...
        try {
          ...
          final apiResponse = await model.authRequest.socialLogin(googleUser.email, googleAuth?.idToken, "google");
          //
          if (apiResponse != null) {
    ...
    try {
      ...
      if (result.status == LoginStatus.success) {
        ...
        try {
          ...
          // Once signed in, return the UserCredential
          UserCredential userAccount = await FirebaseAuth.instance.signInWithCredential(
